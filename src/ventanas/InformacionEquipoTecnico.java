...
public class InformacionEquipoTecnico extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txp_observaciones.setEditable(false);
    ...
    private void btn_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_actualizarActionPerformed
        ...
        comentariosTecnicos = txp_comentariosTecnico.getText();
        tecnico = user;
        ...
        try {
            ...
            Connection cn = Conexion.conectar();
            PreparedStatement pst = cn.prepareStatement(
            "update equipos set estatus=?,comentarios_tecnico=?,revision_tecnica_de=? where id_equipo = '" + IDequipo + "'");
